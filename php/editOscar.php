    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Modifier un compte OSCAR</h1>
        </div>
        <?php
        ...
        if(isset($_GET["mat"])) {
          ...
          if(!empty($_POST)) {
            ...
            $sql = "UPDATE OSCAR.dbo.Compte AS OSCAR 
            SET OSCAR.Cpte_Matricule = ?, OSCAR.Cpte_Nom = ?, OSCAR.Cpte_Prenom = ?, OSCAR.Cpte_Email = ?, OSCAR.Cpte_Service = ?, OSCAR.Cpte_Fonction = ?, OSCAR.Cpte_DUT = ?, OSCAR.Cpte_Region = ? 
            WHERE OSCAR.Cpte_Matricule = ?";
            $params = array($mat, $nom, $prenom, $email, $service, $fonction, $dut, $region);
          ...
          <form action="<?php echo 'update.php?mat='.$mat;?>" method="post">
            ...
            <div class="form-group">
                <label for="description">Fonction:
                <input type="text" class="form-control" name="fonction" value="<?php echo $fonction;?>">
            </div>
            <div class="form-group">
                <label for="name">DUT:
                <input type="text" class="form-control" name="dut" value="<?php echo $dut;?>">                
            </div>
            <div class="form-group">
                <label for="description">Region:
