    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Ajouter un compte GRAAL</h1>
          ...
          if (isset($_GET["mat"])) {
            ...
            if( $stmtSirh === false ) {
              ...
              if(isset($_POST['noUt']) && isset($_POST['role'])) {
                ...
                $sql = "INSERT INTO GRAAL.dbo.Compte AS GRAAL (GRAAL.Matricule, GRAAL.Nom, GRAAL.Prenom, GRAAL.Email, GRAAL.NoUt, GRAAL.Role) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        <div class="col-md-8 order-md-1">
          <form class="form" action="addOscar.php" method="post">
            <div class="mb-3">
              <input type="text" class="form-control" name="noUt" placeholder="N° UT">
            </div>
