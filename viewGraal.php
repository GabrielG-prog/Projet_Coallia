    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Voir un compte GRAAL</h1>
        </div>
        <?php
        ...
        if (isset($_GET["mat"])) {
          ...
          <form>
            <div class="form-group">
              <label>Matricule:</label><?php echo '  '.$item['Matricule'];?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>Role:</label><?php echo '  '.$item['Role'];?>
            </div>
          </form>
        <?php
          ...
          echo'<a class="btn btn-primary" href="editGraal.php?mat='.$mat.'"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>';
        } else {
          echo'Erreur URL';
        }  
        ?>
